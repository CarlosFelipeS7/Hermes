...
public class UsuarioDAO {
    ...
    public void inserir(Usuario u) throws Exception {
        String sql = "INSERT INTO usuario (nome, email, senha, tipo_usuario, telefone, endereco, veiculo, documento) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public Usuario autenticar(String email, String senha, String tipoUsuario) throws Exception {
    ...
    public void atualizar(Usuario u) throws Exception {
        String sql = "UPDATE usuario SET nome=?, email=?, senha=?, telefone=?, endereco=?, veiculo=?, documento=? WHERE id=?";
        try (Connection conn = Conexao.getConnection();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
